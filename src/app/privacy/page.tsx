      ...
      <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mt-12">
        ...
        <p className="mb-4 text-gray-700 dark:text-gray-200">
          ...
          <ul className="list-disc list-inside ml-4 mt-1">
            <li><strong>Consent (Art. 6(1)(a)):</strong> We rely on your consent when you sign up, upload content, and use specific features of StudySync. <strong>We obtain your explicit consent for activities such as uploading files or using AI features. By using these features, you are providing us with consent to process your data for these specific purposes.</strong></li>
