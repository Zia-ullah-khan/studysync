    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mt-12">
        ...
        <p className="mb-2 text-gray-700 dark:text-gray-200">
          For questions about these terms, contact us at <a href="mailto:support@studysync.com" className="text-blue-600 dark:text-blue-400 underline">support@studysync.com</a>.
        </p>
